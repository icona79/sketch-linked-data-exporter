...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var _require2 = __webpack_require__(/*! sketch */ "sketch"),
      getSelectedDocument = _require2.getSelectedDocument,
      Style = _require2.Style;

  var _require3 = __webpack_require__(/*! sketch/ui */ "sketch/ui"),
  ...
  var walk = function walk(layer, extract, initialValue) {
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        var v = isLayerGroup(l) ? walk(l.layers, extract, undefined) : extract(l);
...
function objectectLowerCase(object) {
  ...
  var lowerCaseObjectKeys = function lowerCaseObjectKeys(obj) {
    return Object.fromEntries(Object.entries(obj).map(objectKeyMapper));
  }; // Converts keys to lowercase, detects object values
  // and sends them off for further conversion


  var objectKeyMapper = function objectKeyMapper(_ref3) {
    var _ref4 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_ref3, 2),
        key = _ref4[0],
        val = _ref4[1];

    return [key.toLowerCase(), isObject(val) ? lowerCaseObjectKeys(val) : val];
  };

  var newObject = lowerCaseObjectKeys(lowercaseObjectValues(object));
  return newObject;
}
/**
...
function lowercaseObjectValues(object) {
  if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(object) === "object") {
    for (var keys in object) {
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(object[keys]) === "object") {
        lowercaseObjectValues(object[keys]);
      } else {
        var keyValue = object[keys];
...
function getKeyByValue(object, value) {
  var discard = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
...
function createNestedObject(object, keys, value) {
  ...
  var lastKey = arguments.length === 3 ? keys.pop() : false; // Walk the hierarchy, creating new objects where needed.
  ...
  if (lastKey) object = object[lastKey] = value; // Return the last object in the hierarchy:
